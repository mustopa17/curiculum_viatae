...
// Ambil data dari database yang ingin diubah
...
$query_update = "UPDATE cv set Nama = ? , alamat = ?, telepon= ? ,email =? ,web =? , pendidikan =? , pengalaman_kerja =? , keterampilan = ? , foto_path = ?";

$stmt = mysqli_prepare($konek , $query_update);
...
<body >
    <nav class="navbar sticky-top bg-body-tertiary biru">
      <div class="container-fluid">
        <h1>Update CV</h1>
        <a class="navbar-brand" href="index.php ">Lihat Hasil</a>
      </div>
    </nav>
